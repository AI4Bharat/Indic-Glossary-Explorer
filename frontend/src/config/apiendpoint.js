const apiendpoint =  {
    login: "/glossary-explorer/v1/login",
    signup: "/glossary-explorer/v1/signup",
    searchGlossary: "/glossary-explorer/v1/sentence/phrases/search",
    uploadGlossary: "/glossary-explorer/v1/glossary/file/upload",
